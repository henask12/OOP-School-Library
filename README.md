...
The OOP School Library is a software system designed to efficiently manage the library resources and services in a school setting. This project leverages the principles of Object-Oriented Programming to model and organize different aspects of the library.
...
<details>
  ...
  <ul>
    <li><a href="https://www.ruby-lang.org/en/">Ruby offcial website</a></li>
  </ul>
</details>
...
```sh
  git clone https://github.com/henask12/OOP-School-Library.git
